(() => {
  ...
  function createOberkirchBuildings() {
    ...
    for (const config of OBERKIRCH_BUILDINGS) {
      ...
      // Church remains one untouched transparent foreground PNG. Therefore
      // transparent pixels reveal the player, while visible tower pixels
      // naturally cover him when he walks through either walk-behind zone.
